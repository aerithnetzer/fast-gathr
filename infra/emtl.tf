  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "EMTL_CHATBOT_PROVIDER", value = "aws_bedrock" },
        { name = "EMTL_STAGE_PROVIDER", value = "aws_bedrock" },
        { name = "AWS_REGION", value = var.aws_region },
        { name = "EMTL_BEDROCK_MODEL_ID", value = var.bedrock_model_id },
        { name = "EMTL_BEDROCK_MAX_TOKENS", value = "8192" },
        { name = "EMTL_BEDROCK_TEMPERATURE", value = "0.1" },
